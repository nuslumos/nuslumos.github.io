...
### Journal
1. Li, R., Liu, Y., Liu, X., and Nie, Y. (2024) [Allocation problem in cross-platform ride-hail integration](https://authors.elsevier.com/c/1jfAohVEBCeGA), Transportation Research Part B: Methodological, 188, 103056. 
2. Chen, E., Liu, Y., Yang, M., Ye, Z., and Nie, Y. (2024) [The sustainability appeal of urban rail transit](https://authors.elsevier.com/c/1jNlX3Rd3v3e7J), Transportation Research Part A: Policy and Practice, 186, 104152. 
3. Yang, S. and Liu, Y.* (2024) [Markov Game for CV Joint Adaptive Routing in Stochastic Traffic Networks: A Scalable Learning Approach](https://www.sciencedirect.com/science/article/pii/S0191261524001218), Transportation Research Part B: Methodological (In press).
4. Liu, J., Jiang, R., Liu, Y., Jia, B., Li, X., and Wang, T. (2024) [Managing evacuation of multiclass traffic flow: Fleet configuration, lane allocation, lane reversal, and cross elimination](https://www.sciencedirect.com/science/article/pii/S1366554524000206), Transportation Research Part E: Logistics and Transportation Review, 183, 103430.
5. Chen, Y., Liu, Y.*, Bai, Y., and Mao, B. (2024) [Real-time dispatch management of shared autonomous vehicles with on-demand and pre-booked requests](https://www.sciencedirect.com/science/article/pii/S0965856424000697), Transportation Research Part A: Policy and Practice, 181, 104021.
6. Zhang, S., Sun, H., Liu, Y., Lv, Y., Wu, J., and Feng, X. (2024) [Carsharing equitable relocation problem: A two-stage stochastic programming approach with learning-embedded endogenous uncertainty in demand](https://www.sciencedirect.com/science/article/pii/S0191261523001935?dgcid=coauthor), Transportation Research Part B: Methodological, 179, 102868.
7. Wang, S., Li, X., Chen, Z., and Liu, Y.* (2023) [A Railway Accident Prevention System Using An Intelligent Pilot Vehicle](https://ieeexplore.ieee.org/document/10337782). IEEE Transactions on Intelligent Transportation Systems, IEEE Transactions on Intelligent Transportation Systems, 25 (6), 5170-5188.
...
12.	Xie, J., Liu, Y.*, and N. Chen (2023) [Two-Sided Deep Reinforcement Learning for Dynamic Mobility-on-Demand Management with Mixed-Autonomy](https://pubsonline.informs.org/doi/full/10.1287/trsc.2022.1188), Transportation Science, 57(4):1019-1046.
13. Chen, Y. and Liu, Y.* (2022) [Integrated Optimization of Planning and Operations for Shared Autonomous Electric Vehicle Systems](https://pubsonline.informs.org/doi/abs/10.1287/trsc.2022.1156), Transportation Science, 57(1):106-134.
...
17.	Xie, T. and Liu Y.* (2022) [Heterogeneous Information Provision on Traffic Networks with Competitive or Cooperative Information Providers](https://www.sciencedirect.com/science/article/pii/S0968090X22001954),  Transportation Research Part C: Emerging Technologies, 142, 103762.
