...
![]({{ site.url }}{{ site.baseurl }}/images/newspic/2026_ISTTT26_pic1.JPG){: style="width: 70%; float: left;margin-right: 30px; border: 10px"}

![]({{ site.url }}{{ site.baseurl }}/images/newspic/2026_ISTTT26_pic2.JPG){: style="width: 70%; float: left;margin-right: 30px; border: 10px"}
